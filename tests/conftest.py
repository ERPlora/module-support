"""Pytest fixtures for support module tests."""
import uuid
import pytest
...
from support.models import TicketCategory, SupportSettings, Ticket, TicketMessage
...
@pytest.fixture
def ticket(db, hub_id):
    """Create a test Ticket."""
    return Ticket.objects.create(
        hub_id=hub_id,
        ticket_number='NUM-001',
